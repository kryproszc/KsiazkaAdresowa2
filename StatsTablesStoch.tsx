...
function SimResults() {
  const { stats, quantileResult, percentileMatch, percentileInputSim } = useStochStore();
...
function SimDiff() {
  const { stats, quantileResult, percentileMatch, percentileInputDiff } = useStochStore();
  if (!quantileResult) return null;
